...
class Logger {
    ...
    companion object {
        ...
        @JvmStatic
        fun printJsonRequest(builder: io.merculet.core.api.interceptor.LoggingInterceptor.Builder, request: Request) {

            val tag = builder.getTag(true)

            val builder = StringBuilder()
            builder.append("  ").append(LINE_SEPARATOR).append(TOP_BORDER).append(LINE_SEPARATOR)
        ...
        @JvmStatic
        fun printFileRequest(builder: io.merculet.core.api.interceptor.LoggingInterceptor.Builder, request: Request) {
        ...
        @JvmStatic
        fun printJsonResponse(builder: io.merculet.core.api.interceptor.LoggingInterceptor.Builder, chainMs: Long, isSuccessful: Boolean,
        ...
        @JvmStatic
        fun printFileResponse(builder: io.merculet.core.api.interceptor.LoggingInterceptor.Builder, chainMs: Long, isSuccessful: Boolean,
